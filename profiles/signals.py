...
#             recipient=instance,
#             content='Your default notification settings have been created.',
#             notification_type=NotificationType.objects.get(type_name='default_settings'),
#             url='/your-url/'  # Replace with actual URL if applicable
#         )

# # Signal to create default notification settings for a new UserProfile
...
#             NotificationUtils.create_notification(
#                 recipient=user,
#                 content=f'Your default notification settings for {type_name} have been created.',
...
#     if created:
#         NotificationUtils.create_notification(
#             recipient=instance.skill.user_profile.user,
#             content=f"Your skill '{instance.skill.name}' has been endorsed by {instance.endorsed_by.userprofile.get_full_name()}",
#             notification_type=NotificationType.objects.get(type_name='endorsement'),
#             url='/your-url/'  # Replace with actual URL if applicable
#         )
...
#             notification_type=NotificationType.objects.get(type_name='profile_update'),
#             url='/your-url/'  # Replace with actual URL if applicable
#         )
...
#     if not instance._state.adding and instance.profile_picture != instance.profile_picture:
#         instance.resize_profile_picture()

# # Signal to trigger actions when a user changes the visibility settings of their profile
# @receiver(post_save, sender=UserProfile)
# def profile_visibility_changed(sender, instance, **kwargs):
#     if not instance._state.adding and instance.visibility != instance._visibility:
...
#             notification_type=NotificationType.objects.get(type_name='skill_endorsement'),
#             url='/your-url/'  # Replace with actual URL if applicable
#         )
...
#             notification_type=NotificationType.objects.get(type_name='connection'),
#             url='/your-url/'  # Replace with actual URL if applicable
#         )
